...
import com.campuskart.app.DescriptionPage
import com.campuskart.app.data.SellData
import com.campuskart.app.databinding.SoldRecyclerLayoutBinding
...
class SoldAdapter(
    ...
    private fun deleteModel(model: String) {
        ...
        databaseProd.child(model).removeValue().addOnSuccessListener {
            ...
            val ref = FirebaseDatabase.getInstance("https://campusx-a99d3-default-rtdb.us-central1.firebasedatabase.app")                .getReference("Users")
