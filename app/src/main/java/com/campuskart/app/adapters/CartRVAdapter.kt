...
import com.campuskart.app.databinding.CartLayoutBinding
...
//
    ...
    private fun deleteModel(itemID: String) {
        ...
        val dtb = FirebaseDatabase.getInstance("https://campusx-a99d3-default-rtdb.us-central1.firebasedatabase.app").reference
        val query: Query =
