...
import com.campuskart.app.databinding.GridViewBinding
...
class OnSaleAdapter(
    ...
    private fun deleteModel(model: String) {
        ...
        val ref = FirebaseDatabase.getInstance("https://campusx-a99d3-default-rtdb.us-central1.firebasedatabase.app")
            .getReference("Users")
