...
import com.campuskart.app.adapters.CartRVAdapter
import com.campuskart.app.data.SellData
import com.campuskart.app.databinding.FragmentCartBinding
...
class CartFragment : Fragment() {
    ...
    private fun fetchDataFromDataBase() {
        ...
        val database= FirebaseDatabase.getInstance("https://campusx-a99d3-default-rtdb.us-central1.firebasedatabase.app")
